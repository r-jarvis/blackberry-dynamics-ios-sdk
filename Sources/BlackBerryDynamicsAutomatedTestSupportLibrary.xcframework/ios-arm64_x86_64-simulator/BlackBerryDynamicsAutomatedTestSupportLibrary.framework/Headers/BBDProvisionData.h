...
typedef NS_ENUM(NSInteger, BBDUnlockType) {
    BBDUnlockTypeUnknown,
    BBDUnlockTypeIdp,
    BBDUnlockTypeUnlockKey
} NS_SWIFT_NAME(BBDUnlockType);

@interface BBDProvisionData : NSObject

@property (nonatomic, readonly)  BBDActivationType activationType;
@property (nonatomic, readonly)  BBDUnlockType unlockType;
