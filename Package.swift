...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/MFB-Technologies-Inc/blackberry-dynamics-ios-sdk/releases/download/13.1.0-48p/BlackBerryCerticom.xcframework.zip",
            checksum: "4c0d930586fdbfeab6512f8bd129b3309a10ffadf6591be7ea0494e7fc701218"
        ),
        .binaryTarget(
            name: "BlackBerryCerticomSBGSE",
            url: "https://github.com/MFB-Technologies-Inc/blackberry-dynamics-ios-sdk/releases/download/13.1.0-48p/BlackBerryCerticomSBGSE.xcframework.zip",
            checksum: "08f6d4a0607ff97f87732d1da87a1f3cf4e34c699b448f2c5abb08630d52e344"
        ),
        .binaryTarget(
            name: "BlackBerryDynamics",
            url: "https://github.com/MFB-Technologies-Inc/blackberry-dynamics-ios-sdk/releases/download/13.1.0-48p/BlackBerryDynamics.xcframework.zip",
            checksum: "8d74ab2bbae407745fd2d34bef2ba44ebabdd004963e0e8d8cc8ec9361d5f992"
        ),
        .binaryTarget(
            name: "BlackBerryDynamicsAutomatedTestSupportLibrary",
            url: "https://github.com/MFB-Technologies-Inc/blackberry-dynamics-ios-sdk/releases/download/13.1.0-48p/BlackBerryDynamicsAutomatedTestSupportLibrary.xcframework.zip",
